...
/**
  ...
  */
//class BasicInteractionFlowTests extends TestSuite {
//
//  FastTestScheduler.start()
//
//  val a = (0 until 3).map(i => Agent(Node(s"a$i"), State()))
...
//
//      'registering_agents {
//        ap = a map {_a => Network.registerAgent(_a, MockSendReceiveInterface$)}
