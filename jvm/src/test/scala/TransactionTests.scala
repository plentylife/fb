...
//
//        'taking_bids {
//          InternalSendReceiveInterface$.clearLog
//
...
//          waitClearQueue()
//
//          val assertTransactionValid = InternalSendReceiveInterface$.log map {_.payload} collect {
...
//          }
//          val assertNoCoinsMinted = InternalSendReceiveInterface$.log map {_.payloadId == ActionIdentifiers.COINS_MINTED}
//
...
//          waitClearQueue()
//
//          val assertNoSettles = InternalSendReceiveInterface$.log map {_.payloadId} collect {
//            case pid if pid == ActionIdentifiers.SETTLE_BID_ACTION ⇒ true
//          }
//          val assertRetractions = InternalSendReceiveInterface$.log map {_.payloadId} collect {
...
////              cond
////          }
//          val assertCoinsMinted = InternalSendReceiveInterface$.log collect {
...
//            case pid if pid == ActionIdentifiers.RETRACT_BID_ACTION ⇒ true
//          }
//          val assertTransactionValid = InternalSendReceiveInterface$.log map { m ⇒ (m.payload, m.payloadId)} collect {
//            case (t: Transaction, pid) if pid == ActionIdentifiers.APPROVE_SETTLE_BID_ACTION ⇒
//              val liveCoins = Accounting.filterDeadCoins(t.coins)
//              // all coins belong to the bidder and the amount matches the amount agreed upon
